...
for j in range(selected_epochs_data.shape[0]):  # 遍历所有epochs
    for i in range(selected_epochs_data.shape[1]):  # 遍历所有channels
        ...
        noisy_filename = f'F:/Nei2Nei/all_whq/noisy/noisy_{file_index}.mat'
        sio.savemat(noisy_filename, {'data': selected_epochs_data[j, i].astype(np.float64)})

        # 对于每个channel，保存干净的数据
        clean_filename = f'F:/Nei2Nei/all_whq/clean/clean_{file_index}.mat'
...
# 指定源文件夹和目标文件夹路径1
source_noisy = r'F:/Nei2Nei/all_whq/noisy'
source_clean = r'F:/Nei2Nei/all_whq/clean'
target_train_noisy = r'F:/Nei2Nei/all_whq/whq_train/noisy'
target_train_clean = r'F:/Nei2Nei/all_whq/whq_train/clean'
target_valid_noisy = r'F:/Nei2Nei/all_whq/whq_valid/noisy'
target_valid_clean = r'F:/Nei2Nei/all_whq/whq_valid/clean'
target_test_noisy =  r'F:/Nei2Nei/all_whq/whq_test/noisy'
target_test_clean =  r'F:/Nei2Nei/all_whq/whq_test/clean'
